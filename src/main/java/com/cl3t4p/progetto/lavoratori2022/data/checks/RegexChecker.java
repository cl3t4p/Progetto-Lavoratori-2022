...
public enum RegexChecker {
    ...
    /**
     * This regex is used to check if the string is a valid email.
     */
    ...
    /**
     * This regex is used to check if the string is a valid phone number.
     */
    TEL_NUMBER("^[\\+]?[(]?[0-9]{3}[)]?[-\\s\\.]?[0-9]{3}[-\\s\\.]?[0-9]{4,6}$");
