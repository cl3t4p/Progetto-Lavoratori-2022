...
-- Lavoratore Test
INSERT INTO public.lavoratore(
    nome, cognome, luogo_nascita, data_nascita, nazionalita, indirizzo, telefono, email, automunito, inizio_periodo_disp, fine_periodo_disp, id_dipendente)
VALUES ('Test', 'Tester', 'LC', '1980-01-11', 'IT', 'Via Test', 5564788599, 'test@testing.com', 'SI', '2019-01-11', '2025-01-11',1);
-- Patenti
INSERT INTO public.patente VALUES
                               ('AM'),
                               ('A1'),
                               ('A2'),
                               ('A'),
...
-- Comuni
INSERT INTO public.comune VALUES
                              ('BOVINO'),
                              ('CALCIO'),
                              ('ABANO TERME'),
                              ('ABBADIA CERRETO'),
