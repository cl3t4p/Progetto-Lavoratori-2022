...
COPY public.comune (nome_comune) FROM stdin;
ABANO TERME
ABBADIA CERRETO
ABBADIA LARIANA
...
--
-- Data for Name: esp_lav; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.esp_lav (esperienza, id_lavoratore) FROM stdin;
\.


--
-- Data for Name: esperienza; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.esperienza (nome_esperienza) FROM stdin;
\.


--
-- Data for Name: lav_comune; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.lav_comune (comune, id_lavoratore) FROM stdin;
\.
...
--
-- Data for Name: lingua; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.lingua (nome_lingua) FROM stdin;
\.


--
-- Data for Name: lingua_lav; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.lingua_lav (nome_lingua, id_lavoratore) FROM stdin;
\.


--
-- Data for Name: pat_lav; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.pat_lav (nome_patente, id_lavoratore) FROM stdin;
\.
...
COPY public.patente (tipo_patente) FROM stdin;
\.
